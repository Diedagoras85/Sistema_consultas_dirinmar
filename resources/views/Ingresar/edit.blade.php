          ...
          <form action="guardar" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
              <div class="grid grid-cols-1">
                ...
                <input name="nombre" value={{$n}} class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text"  />
              </div>
              <div class="grid grid-cols-1">
            ...
            <div class='flex items-center justify-center  md:gap-8 gap-4 pt-5 pb-5'>
              ...
              <!--<a href={{route('home')}} class='w-auto bg-gray-500 hover:bg-gray-700 rounded-lg shadow-xl font-medium text-white px-4 py-2'>Volver</a>-->
